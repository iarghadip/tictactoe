...
function StatPill({ label, value }) {
    return (
        <div className="flex score-stat-pill">
...
export default function Score({ stats, loading = false }) {
    if (!stats) {
        return (
            <div className="flex score-stats score-stats--empty">
                {loading
    ...
    return (
        <div className="flex score-stats">
            <div className="flex score-stats__top">
            ...
            <div className="flex score-stats__stats">
